...
while opcao != '0':
    match opcao:
        case '1': 
            req(endpoint_url, 'Identify') #identify
        case '2': 
            req(endpoint_url, 'ListSets') #listsets
        case '3': 
            req(endpoint_url, 'ListMetadataFormats') #listmetadataformats
        case '4': 
            req(endpoint_url, 'ListRecords', 'aif') #listrecords
        case _:
